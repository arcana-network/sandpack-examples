...
export declare class ERC4337EthersProvider extends BaseProvider {
    ...
    constructor(config: ClientConfig, originalSigner: Signer, originalProvider: BaseProvider, httpRpcClient: HttpRpcClient, entryPoint: EntryPoint, smartAccountAPI: BaseAccountAPI);
    init(): Promise<this>;
    ...
    constructUserOpTransactionResponse(userOp1: UserOperation, transactionId: string, engine?: any): Promise<TransactionResponse>;
