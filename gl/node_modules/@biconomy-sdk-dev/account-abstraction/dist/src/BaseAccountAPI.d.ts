...
import { SmartWalletContractV100 } from '@biconomy-sdk-dev/ethers-lib';
...
import { NotPromise } from '@biconomy-sdk-dev/common';
...
export declare abstract class BaseAccountAPI {
    ...
    readonly overheads?: Partial<GasOverheads> | undefined;
     ...
     * our wallet contract.
     */
    accountContract: SmartWalletContractV100;
    /**
     * base constructor.
     ...
     */
    protected constructor(provider: Provider, entryPoint: EntryPoint, // we could just get an address : evaluate
    clientConfig: ClientConfig, // review the need to get entire clientconfig
    accountAddress?: string | undefined, overheads?: Partial<GasOverheads> | undefined);
    connectPaymaster(newPaymasterAPI: IPaymasterAPI): BaseAccountAPI;
    _getSmartAccountContract(): Promise<SmartWalletContractV100>;
    init(): Promise<this>;
    /**
     ...
     */
    checkAccountDeployed(): Promise<boolean>;
    /**
    ...
    encodeUserOpCallDataAndGasLimit(detailsForUserOp: TransactionDetailsForBatchUserOp): Promise<{
        callData: string;
     ...
     */
    createSignedUserOp(info: TransactionDetailsForBatchUserOp): Promise<UserOperation>;
    /**
