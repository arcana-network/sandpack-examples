...
export declare class SmartAccountProvider extends BaseProvider {
    readonly originalSigner: Signer;
    readonly originalProvider: BaseProvider;
    readonly signer: SmartAccountSigner;
    constructor(tempProvider: Web3Provider, chainId: ChainId, originalSigner: Signer, // EOASigner
    ...
    constructSmartAccountTransactionResponse(): Promise<TransactionResponse | null>;
}
