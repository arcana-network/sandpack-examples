...
import { Bundlerconfig, UserOpResponse, UserOpReceipt, UserOpGasResponse, UserOpByHashResponse, GasFeeValues, UserOpStatus, SimulationType } from "./utils/Types";
/**
...
export declare class Bundler implements IBundler {
     ...
     */
    sendUserOp(userOp: UserOperation, simulationType?: SimulationType): Promise<UserOpResponse>;
    /**
     *
     * @param userOpHash
