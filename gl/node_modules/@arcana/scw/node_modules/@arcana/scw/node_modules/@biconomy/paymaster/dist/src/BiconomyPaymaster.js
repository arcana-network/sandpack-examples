...
class BiconomyPaymaster {
    ...
    async prepareUserOperation(userOp) {
        ...
        if (userOp.maxFeePerGas !== null && userOp.maxFeePerGas !== undefined) {
            userOp.maxFeePerGas = ethers_1.BigNumber.from(userOp.maxFeePerGas).toString();
        }
        if (userOp.maxPriorityFeePerGas !== null && userOp.maxPriorityFeePerGas !== undefined) {
            userOp.maxPriorityFeePerGas = ethers_1.BigNumber.from(userOp.maxPriorityFeePerGas).toString();
        }
    ...
    async getPaymasterFeeQuotesOrData(userOp, paymasterServiceData) {
        ...
        const calculateGasLimits = (_a = paymasterServiceData.calculateGasLimits) !== null && _a !== void 0 ? _a : true;
        ...
        feeTokensArray = (((_b = paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.tokenList) === null || _b === void 0 ? void 0 : _b.length) !== 0 ? paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.tokenList : feeTokensArray);
        webhookData = (_c = paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.webhookData) !== null && _c !== void 0 ? _c : webhookData;
        smartAccountInfo = (_d = paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.smartAccountInfo) !== null && _d !== void 0 ? _d : smartAccountInfo;
        try {
    ...
    async getPaymasterAndData(userOp, paymasterServiceData) {
        ...
        expiryDuration = (_d = paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.expiryDuration) !== null && _d !== void 0 ? _d : expiryDuration;
