...
export declare class BiconomySmartAccount extends SmartAccount implements IBiconomySmartAccount {
    ...
    buildUserOp(transactions: Transaction[], overrides?: Overrides, skipBundlerGasEstimation?: boolean, paymasterServiceData?: SponsorUserOperationDto): Promise<Partial<UserOperation>>;
    ...
    getUpdateImplementationData(newImplementationAddress?: string): Promise<Transaction>;
    getModuleSetupData(ecdsaModuleAddress?: string): Promise<Transaction>;
    updateImplementationUserOp(newImplementationAddress?: string, ecdsaModuleAddress?: string): Promise<Partial<UserOperation>>;
}
