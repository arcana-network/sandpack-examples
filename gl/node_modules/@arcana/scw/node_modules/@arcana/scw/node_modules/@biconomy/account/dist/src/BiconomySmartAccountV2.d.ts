...
import { BiconomyTokenPaymasterRequest, BiconomySmartAccountV2Config, CounterFactualAddressParam, BuildUserOpOptions, QueryParamsForAddressResolver } from "./utils/Types";
...
export declare class BiconomySmartAccountV2 extends BaseSmartAccount {
    ...
    getV1AccountsUpgradedToV2(params: QueryParamsForAddressResolver): Promise<string>;
    /**
    ...
    signUserOpHash(userOpHash: string, params?: SendUserOpParams): Promise<string>;
