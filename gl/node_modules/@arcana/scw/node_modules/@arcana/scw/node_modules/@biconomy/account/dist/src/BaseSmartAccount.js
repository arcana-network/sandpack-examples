...
class BaseSmartAccount {
    ...
    async calculateUserOpGasValues(userOp) {
        ...
        if (userOp.initCode)
            userOp.verificationGasLimit = (_e = userOp.verificationGasLimit) !== null && _e !== void 0 ? _e : (await this.getVerificationGasLimit(userOp.initCode));
        userOp.callGasLimit =
            (_f = userOp.callGasLimit) !== null && _f !== void 0 ? _f : (await this.provider.estimateGas({
                from: this.entryPointAddress,
                to: userOp.sender,
                data: userOp.callData,
            }));
        userOp.preVerificationGas = (_g = userOp.preVerificationGas) !== null && _g !== void 0 ? _g : (await this.getPreVerificationGas(userOp));
        return userOp;
    }
    async estimateUserOpGas(params) {
        ...
        if (skipBundlerCall) {
            if (this.paymaster && this.paymaster instanceof paymaster_1.BiconomyPaymaster) {
                ...
                {
                    common_1.Logger.warn("Skipped paymaster call. If you are using paymasterAndData, generate data externally");
