...
class BiconomyPaymaster {
    ...
    async buildTokenApprovalTransaction(tokenPaymasterRequest, provider) {
        ...
        if (tokenPaymasterRequest.maxApproval && tokenPaymasterRequest.maxApproval == true) {
            ...
            requiredApproval = Math.ceil(tokenPaymasterRequest.feeQuote.maxGasFee *
                Math.pow(10, tokenPaymasterRequest.feeQuote.decimal)).toString();
        }
    ...
    async getPaymasterFeeQuotesOrData(userOp, paymasterServiceData) {
        ...
        preferredToken = (paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.preferredToken)
            ? paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.preferredToken
            : preferredToken;
        common_1.Logger.log('userop is ', userOp);
        feeTokensArray = (((_a = paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.tokenList) === null || _a === void 0 ? void 0 : _a.length) !== 0
            ? paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.tokenList
            : feeTokensArray);
        ...
        try {
            ...
            if (!this.paymasterConfig.strictMode &&
                ...
                ((error === null || error === void 0 ? void 0 : error.message.includes('Smart contract data not found')) ||
                    (error === null || error === void 0 ? void 0 : error.message.includes('No policies were set')))
     ...
     */
    async getPaymasterAndData(userOp, paymasterServiceData // mode is necessary. partial context of token paymaster or verifying
    ) {
        var _a, _b, _c;
        // TODO
        try {
        ...
        const calculateGasLimits = (paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.calculateGasLimits)
            ? paymasterServiceData.calculateGasLimits
            : false;
        common_1.Logger.log('calculateGasLimits is ', calculateGasLimits);
        let tokenInfo = null;
        ...
        if (mode === Types_1.PaymasterMode.ERC20) {
            if (!(paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.feeTokenAddress) &&
                (paymasterServiceData === null || paymasterServiceData === void 0 ? void 0 : paymasterServiceData.feeTokenAddress) === ethers_1.ethers.constants.AddressZero) {
     ...
     */
    async getDummyPaymasterAndData(userOp, paymasterServiceData // mode is necessary. partial context of token paymaster or verifying
    ) {
        common_1.Logger.log('userOp is ', userOp);
